...
Спроси пользователя для какого аккаунта нужен креатив. Проверь список аккаунтов в `config/ad_accounts.md`

### Шаг 2: Прочитай бриф
**КРИТИЧНО:** Прочитай `config/briefs/{account}.md`
...
**Действия:**
1. Читаю бриф `config/briefs/bas_dent.md`
